// src/screens/CreateItemScreen.js
...
// Tente importar o ImagePicker, se não existir, use null
let ImagePicker = null;
try {
  ImagePicker = require('expo-image-picker');
} catch (e) {
  console.warn('expo-image-picker não instalado. Execute: npx expo install expo-image-picker');
}
  ...
  const pickImage = async () => {
    if (!ImagePicker) {
      Alert.alert(
        ...
        'Para usar upload de imagens, execute:\nnpx expo install expo-image-picker'
      );
      return;
    }
